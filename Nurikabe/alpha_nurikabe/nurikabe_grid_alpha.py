...
from utils import NurikabeGrid, custom_encoder
import numpy as np


class NurikabeGridAlpha(NurikabeGrid):
    """ Overides some functions of parent NurikabeGrid.
    ...
    def take_action(self, index, action, proba):
        new_grid = NurikabeGridAlpha(self.grid.grid.copy(),
                                   self.solution.copy(),
                                   self.model,
                                   proba)
